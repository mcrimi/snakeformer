...
class SnakeGame:
    ...
    def calculate_food_spawn_pos(self, snake):
        ...
        Why deterministic?
            1) Because the training engine is unable to learn from random food spawn positions.
            2) Because we want to be able to compare the predicted food spawn position with the actual food spawn position.
        """
        head = snake[0]
